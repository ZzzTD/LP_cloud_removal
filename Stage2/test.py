...
parser = argparse.ArgumentParser(description='Test Modulation_refinement on your own images')
# 待预测图象
parser.add_argument('--input_dir', default='', type=str, help='Directory of input images or path of single image')
parser.add_argument('--result_dir', default='', type=str, help='Directory for restored results')
...
load_arch = run_path(os.path.join('basicsr', 'models', 'archs', 'MRM.py'))
model = load_arch['Modulation_refinement'](**parameters)
