...
if condition:
    if input_condition:
        ...
        folder = ["E:/RS_cloud_removal/experiments/Discussion/Whole_image/dataset_1024/train/hq.flist",
                "E:/RS_cloud_removal/experiments/Discussion/Whole_image/dataset_1024/train/lq.flist",
                "E:/RS_cloud_removal/experiments/Discussion/Whole_image/dataset_1024/test/hq.flist",
                "E:/RS_cloud_removal/experiments/Discussion/Whole_image/dataset_1024/test/lq.flist"]
    train_batch_size = 1
    num_samples = 1
    sum_scale = 1
    image_size = 128
